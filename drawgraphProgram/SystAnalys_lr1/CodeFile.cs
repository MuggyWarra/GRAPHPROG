...
namespace SystAnalys_lr1
{
    ...
    class Edge
    {
        ...
        public Edge(int v1, int v2)
        {
            this.v1 = v1;
            this.v2 = v2;
            this.weight = 0; // инициализируем вес ребра нулем
        }
    }
    class DrawGraph
    {
        ...
        public void clearEdgeWeight(Edge E){ E.weight = 0; }// Очищаем вес ребра
        ...
        public void drawEdge(Vertex V1, Vertex V2, Edge E, int numberE)
        {
            ...
            else
            {
                ...
                point = new PointF((V1.x + V2.x) / 2, (V1.y + V2.y) / 2 + 2);
        ...
        {            
            for (int i = 0; i < E.Count; i++)//рисуем ребра
            {
                if (E[i].v1 == E[i].v2)
                {
            ...
            for (int i = 0; i < V.Count; i++)//рисуем вершины
            {
